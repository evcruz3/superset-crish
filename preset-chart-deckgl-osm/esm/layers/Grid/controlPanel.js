...
import { filterNulls, autozoom, jsColumns, jsDataMutator, jsTooltip, jsOnclickHref, extruded, gridSize, viewport, spatial, osmStyle } from '../../utilities/Shared_DeckGL';
var config = {
  controlPanelSections: [{
    ...
    label: t('Map'),
    controlSetRows: [[osmStyle], [viewport], ['color_scheme'], [autozoom], [gridSize], [extruded]]
  }, {
    label: t('Advanced'),
