...
import { filterNulls, autozoom, jsColumns, jsDataMutator, jsTooltip, jsOnclickHref, legendFormat, legendPosition, fillColorPicker, strokeColorPicker, filled, stroked, extruded, viewport, pointRadiusFixed, multiplier, lineWidth, lineType, reverseLongLat, osmStyle } from '../../utilities/Shared_DeckGL';
import { dndLineColumn } from '../../utilities/sharedDndControls';
var config = {
  controlPanelSections: [{
    label: t('Query'),
    expanded: true,
    controlSetRows: [[_extends({}, dndLineColumn, {
      config: _extends({}, dndLineColumn.config, {
        label: t('Polygon Column')
      })
    })], [_extends({}, lineType, {
      config: _extends({}, lineType.config, {
        label: t('Polygon Encoding')
      })
    })], ['adhoc_filters'], ['metric'], [_extends({}, pointRadiusFixed, {
      config: _extends({}, pointRadiusFixed.config, {
        label: t('Elevation')
      })
    ...
    expanded: true,
    controlSetRows: [[fillColorPicker, strokeColorPicker], [filled, stroked], [extruded], [multiplier], [lineWidth], [{
      name: 'line_width_unit',
      config: {
        type: 'SelectControl',
        label: t('Line width unit'),
        default: 'pixels',
        choices: [['meters', t('meters')], ['pixels', t('pixels')]],
        renderTrigger: true
      }
    }], ['linear_color_scheme'], [{
      name: 'opacity',
