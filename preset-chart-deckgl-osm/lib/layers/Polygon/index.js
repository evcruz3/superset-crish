...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Visualizes geographic areas from your data as polygons on a Mapbox rendered map. Polygons can be colored using a metric.'),
  name: (0, _core.t)('deck.gl Polygon'),
  thumbnail: _thumbnail.default,
  exampleGallery: [{
    url: _example.default
  }],
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('3D'), (0, _core.t)('Multi-Dimensions'), (0, _core.t)('Geo')]
});
class PolygonChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
