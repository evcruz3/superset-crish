...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Overlays a hexagonal grid on a map, and aggregates data within the boundary of each cell.'),
  exampleGallery: [{
    url: _example.default
  }],
  name: (0, _core.t)('deck.gl 3D Hexagon'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('3D'), (0, _core.t)('Geo'), (0, _core.t)('Comparison')]
});
class HexChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./Hex'))),
