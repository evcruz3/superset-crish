...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('A map that takes rendering circles with a variable radius at latitude/longitude coordinates'),
  name: (0, _core.t)('deck.gl Scatterplot OSM'),
  thumbnail: _thumbnail.default,
  exampleGallery: [{
    url: _example.default
  }],
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('Comparison'), (0, _core.t)('Scatter'), (0, _core.t)('2D'), (0, _core.t)('Geo'), (0, _core.t)('Intensity'), (0, _core.t)('Density')]
});
class ScatterChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
