...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Aggregates data within the boundary of grid cells and maps the aggregated values to a dynamic color scale'),
  name: (0, _core.t)('deck.gl Screen Grid'),
  thumbnail: _thumbnail.default,
  exampleGallery: [{
    url: _example.default
  }],
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('Comparison'), (0, _core.t)('Intensity'), (0, _core.t)('Density')]
});
class ScreengridChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./Screengrid'))),
