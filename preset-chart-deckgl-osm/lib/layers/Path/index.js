...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Visualizes connected points, which form a path, on a map.'),
  name: (0, _core.t)('deck.gl Path'),
  thumbnail: _thumbnail.default,
  exampleGallery: [{
    url: _example.default
  }],
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('Web')]
});
class PathChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./Path'))),
