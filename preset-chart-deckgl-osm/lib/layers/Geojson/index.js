...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('The GeoJsonLayer takes in GeoJSON formatted data and renders it as interactive polygons, lines and points (circles, icons and/or texts).'),
  exampleGallery: [{
    url: _example.default
  }],
  name: (0, _core.t)('deck.gl Geojson'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('2D')]
});
class GeojsonChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./Geojson'))),
