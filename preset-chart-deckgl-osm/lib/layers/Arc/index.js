...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Plot the distance (like flight paths) between origin and destination.'),
  name: (0, _core.t)('deck.gl Arc'),
  thumbnail: _thumbnail.default,
  exampleGallery: [{
    url: _example.default
  }],
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('Geo'), (0, _core.t)('3D'), (0, _core.t)('Relational'), (0, _core.t)('Web')]
});
class ArcChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
