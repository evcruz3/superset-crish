...
var metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Compose multiple layers together to form complex visuals.'),
  exampleGallery: [{
    url: _example.default
  }],
  name: (0, _core.t)('deck.gl Multiple Layers'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true,
  tags: [(0, _core.t)('deckGL'), (0, _core.t)('Multi-Layers')]
});
class MultiChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./Multi'))),
