  ...
  resolve: {
    ...
    alias: {
      ...
      */
      ...
      '@luma.gl/shadertools': path.resolve(path.join(APP_DIR, './node_modules/@luma.gl/shadertools')),
      '@luma.gl/engine': path.resolve(path.join(APP_DIR, './node_modules/@luma.gl/engine')),
      '@luma.gl/core': path.resolve(path.join(APP_DIR, './node_modules/@luma.gl/core')),
      '@luma.gl/gltf': path.resolve(path.join(APP_DIR, './node_modules/@luma.gl/gltf')),
      '@deck.gl/core': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/core')),
      '@deck.gl/layers': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/layers')),
      '@deck.gl/aggregation-layers': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/aggregation-layers')),
      '@deck.gl/mesh-layers': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/mesh-layers')),
      '@deck.gl/geo-layers': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/geo-layers')),
      '@deck.gl/extensions': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/extensions')),
      '@deck.gl/react': path.resolve(path.join(APP_DIR, './node_modules/@deck.gl/react')),
    },
