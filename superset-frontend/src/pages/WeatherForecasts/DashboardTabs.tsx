...
import { DASHBOARD_ROOT_ID, DASHBOARD_ROOT_DEPTH } from 'src/dashboard/util/constants';
import {
...
function calculateDimensions(windowWidth: number) {
    ...
    const columnWidth = Math.max(minColumnWidth, Math.floor(availableWidth / numColumns));
