...
interface SubsliceFormData extends QueryFormData {
  ...
  metrics?: (string | MetricDefinition)[]; // Added support for multiple metrics
  metric?: string | MetricDefinition; // Kept for backwards compatibility
  primary_metric?: string; // New control for primary coloring metric
  [key: string]: any;
}
interface Subslice {
  slice_id: number;
